...
public class StatusCalculation : MonoBehaviour
{
    ...
    [HideInInspector] public string statusAdd; // Переменная принимает значение добавляемого статуса
    [HideInInspector] public string statusRemove; // Переменная принимает значение удаляемого статуса
